...
export const perks = [
  {
    icon: Icons.auth,
    title: "Sign Up",
    info: "Create your free account to get started with WinteryFox.",
  },
  {
    icon: Icons.customize,
    title: "Customize",
    info: "Choose a template to fit AI-generated content based on your needs.",
  },
  {
    icon: Icons.launch,
    title: "Publish",
    info: "Publish your undetectable AI-generated content and share it with the world.",
  },
];
